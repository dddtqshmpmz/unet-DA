...
from dataset import Dataset,DatasetSemanColor
...
def main():
    ...
    model = smp.Unet('efficientnet-b3', in_channels= 31 ,
    ...
    train_dataset = DatasetSemanColor(
